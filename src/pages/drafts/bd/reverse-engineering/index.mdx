...
When reverse engineering for example a [React](https://reactjs.org) application, you should also make use of the [React Developer Tools extension](https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi/).
